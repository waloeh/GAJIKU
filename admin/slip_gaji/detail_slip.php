...
<body class="background-detail-slip">
<table class="table-detail-slip" border="2" align="center" width="600">
	<tr>
		<th class="pt" colspan="3">Betso Tech Indonesia</th>
	</tr>
	<tr>
		<td colspan="3">
	...
	<tr>
		<td width="200">Koreksi Bulan Lalau</td>
		<td width="200" align="center">-</td>
		<td width="200" align="center"><?php echo $hasil["koreksi"]; ?></td>
	</tr>
	<tr>
		<td width="200">Khas Bon</td>
		<td width="200" align="center">-</td>
		<td width="200" align="center"><?php echo $hasil["kasbon"]; ?></td>
	</tr>
	<tr>
		<td width="200">Total Penerimaan</td>
		<td width="200" align="center">-</td>
		<td width="200" align="center"><?php echo $hasil["total_trma"]; ?></td>
	</tr>
